...
def create_video(images, audio, output, image_phrases):
    ...
    for i, (m, text) in enumerate(zip(images, texts)):
        ...
        img_clip = ImageClip(m).resize(height=1024).set_duration(4).set_fps(30)
...
def main():
    ...
    content = ""
    #Topics: Books, Movies, Music, Health, Technology, Science, History, Art, Food, Travel, Research papers
    content = generate_content("Arxiv Research Paper: Attention Is All You Need", 5)
